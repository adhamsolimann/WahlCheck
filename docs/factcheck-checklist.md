...
**Freigabe-Regel (Freeze-Gate):** Alle Positionen der Tier-Stufen `parliament` und `small` müssen `verification: verified` haben, bevor die Faktencheck-Freeze ausgerufen wird. `contextual`-Parteien folgen best effort.
...
### AfD — 6 offen / 0 erledigt

Programm: **kein Link hinterlegt**

| ✓ | These | Haltung | Zitat (Auszug) | Quelle | Notiz |
|--:|-------|--------:|----------------|--------|-------|
...
### Tierschutzpartei — 3 offen / 0 erledigt
