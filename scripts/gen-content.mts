...
import { loadChangelog, loadContent, loadNews, loadPolls } from "../packages/schemas/src/node.ts";
...
const news = loadNews(contentRoot).sort((a, b) => b.date.localeCompare(a.date));
const out = {
