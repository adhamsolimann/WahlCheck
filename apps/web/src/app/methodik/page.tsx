            ...
            <li key={d.thesisId} className="flex gap-2">
              <span
                className={`mt-0.5 shrink-0 rounded px-1.5 py-0.5 text-xs font-semibold ${
                  d.direction === 1
                    ? "bg-blue-50 text-blue-700 dark:dark:bg-white/10"
                    : "bg-red-50 text-red-700 dark:dark:bg-white/10"
                }`}
              >
  ...
  return (
    <main className="mx-auto max-w-3xl space-y-10 px-6 py-12">
      <header className="space-y-2">
        <h1 className="font-display text-3xl font-bold tracking-tight sm:text-4xl">Methodik</h1>
...
Übersprungene Thesen zählen nirgends.`}
      ...
      <section className="space-y-3">
        ...
        <ul className="list-disc space-y-1 pl-5 text-sm text-ink-700 dark:text-ink-200">
